...
<div id="micFilterLinks"><h3>Filter by Studio <br></h3>
    ...
    <div class="filterMic">
        <h3>
            <a href="list_session.php?studio=1">One</a>
        </h3>
    </div>

    <div class="filterMic">
        <h3>
            <a href="list_session.php?studio=2">Two</a>
        </h3>
    </div>

    <div class="filterMic">
        <h3>
            <a href="list_session.php?studio=3">Three</a>
        </h3>
    </div>

    <div class="filterMic">
        <h3>
            <a href="list_session.php">Clear Filter</a>
        </h3>
    </div>
...
<div class="backupDriveTitle">
    <h3>
        Microphones In Studio<?php if(!empty($studio)){ echo " ".$studio; }else{ echo "s";}; ?>
    </h3>
</div>
